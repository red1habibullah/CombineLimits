...
SampleMap2017['control']=['/eos/uscms/store/user/rhabibul/HtoAA/HtoAA2017/LimitDataSets/rooDatasets_controlRegion.root']

SampleMap2017['datadriven-control']=['/eos/uscms/store/user/rhabibul/HtoAA/HtoAA2017/LimitDataSets/rooDatasets_controlRegion.root']


####################### MC Samples #################################
#TauETauHad_HaaMC_am9_D.root
for a in amasses:
    SampleMap2017[signame.format(h='125',a=a)]=[]
    for c in channels:
        for r in regions:
            SampleMap2017[signame.format(h='125',a=a)].append('/eos/uscms/store/user/rhabibul/HtoAA/HtoAA2017/LimitDataSets/2017Data_RooDatasets/{c}_HaaMC_am{a}_{r}.root'.format(c=c,a=a,r=r))
