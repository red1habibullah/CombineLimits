...
class HaaLimits(Limits):
    ...
    AMASSES = amasses = [4,5,7,8,9,10,11,12,13,14,15,17,18,19,20,21] #['3p6',4,5,6,7,9,11,13,15,17,19,21]
    HAMAP = {
        125 :amasses = [4,5,7,8,9,10,11,12,13,14,15,17,18,19,20,21],  #['3p6',4,5,6,7,9,11,13,15,17,19,21],
        200 : [5,9,15],
        250 : [5,9,15],
